...
public class HelloController {
    ...
    protected void setNum() {
        ...
        koren.setOnAction(actionEvent -> {
            String a = expressionInterface;

            expressionInterface = koren.getText() + a + " = " + Math.sqrt(Integer.parseInt(a));
            Text1.setText("");
        ...
        rovno.setOnAction(actionEvent -> {
            ...
            if (expressionInterface.contains("+")) {
                ...
                try {
                    ...
                    Text2.setText(expressionInterface + cc);
                } catch (Exception a) {
                    Text2.setText("Error");
                }
            } else if (expressionInterface.contains("/")) {
                String[] array = expressionInterface.split(" ");
                System.out.println(expressionInterface);
                try {
                    int a = Integer.parseInt(array[0]);
